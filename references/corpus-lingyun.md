...
> 完整结构化数据（含全文）：lingyun/dataset/gongwen_writing_dataset.jsonl（958 条，含 v0.12 领域素材 53 条；成文范例 5 篇不入 dataset）。
...
- [corpus/lingyun-huishui.md](corpus/lingyun-huishui.md)——主层：凌云笔杆子 177 期+惠水组工 20 期实战方法，35 类速查（190 条）。
...
- [corpus/blogger-wenxiong.md](corpus/blogger-wenxiong.md)——博主蒸馏层·加夜班的文兄（220 期，含 19 图文期）：数字框架库+申论应试视角——每期一个拿来即用的数字框架/高频句式库/万能素材+检视负面表述库/成稿范例（207 条）。
...
- [corpus/chengwen-fanli.md](corpus/chengwen-fanli.md)——法定公文成稿范例层（v0.12 新增，评测 P0-2/P1-6/P2-2）：纪要/通知/请示/批复/函五文种各 1 篇成稿+版式要素清单+关键块详略尺度说明（5 篇，不入 dataset）；法定公文跳过 style-params 量化参数对照，以 format-spec.md 合规为验收标准。
